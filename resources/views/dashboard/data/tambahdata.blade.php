    ...
    <section class="content">
        <div class="container-fluid">
          <div class="col-12">
            <div class="card">
              <div class="card-body">
                <form action="/dashboard/tambahdata" method="POST" enctype="multipart/form-data">
                  @csrf
                  ...
                  <div class="col-8 mb-3">
                    ...
                    <textarea class="form-control @error ('jurusan') is-invalid @enderror" name="jurusan" id="jurusan" rows="3">{{ old('jurusan') }}</textarea>
                  </div>
                  ...
                  <div class="col-8 mb-3">
                    ...
                    <input type="text" name="latitude" class="form-control @error ('latitude') is-invalid @enderror" value="{{ old('latitude') }}" id="latitude" readonly >
                  </div>
                  <div class="col-8 mb-3">
                    <label for="longitude" class="form-label">Longitude</label>
                    <input type="text" name="longitude" class="form-control @error ('longitude') is-invalid @enderror" id="longitude" readonly>
                  </div>
                  <div class="mb-1">
